...
class HelpMenu:
    ...
    def __init__(self, width=1280, height=720):
        ...
        self.font_heading = pygame.font.SysFont("arial", 17, bold=True)
        self.font_body = pygame.font.SysFont("arial", 14, bold=False)
    ...
    def _draw_footer(self, surface):
        ...
        hints = "[1-4] Quick Tab Switch  |  [TAB / Arrows] Cycle Tabs  |  [ESC / H] Return to Game"
    ...
    def _draw_tab_weapons(self, surface, rect):
        ...
        weapons = [
            ...
            },
            {
                ...
                "notes": "Requires active Radar Lock (target inside CONE or OMNI lock zone). Warhead actively turns to track enemy in 2D space.",
                "color": (255, 120, 60),
            },
            {
    ...
    def _draw_tab_abilities(self, surface, rect):
        ...
        col2_items = [
            ...
            {
                "tier": "PASSIVE SHIP DEFENSE SYSTEMS",
                "tier_color": (255, 200, 80),
                "name": "Deflector Shield & Hull Integrity",
                "dur": "Permanent Passive",
                "stats": "Max Shield: 20  |  Passive Regen: +1 every 2.0s  |  Hull HP: 5",
                "desc": "Energy shield takes damage before hull. Depleted hull triggers respawn screen.",
                "color": (100, 200, 255),
            },
            {
                "tier": "SURVIVAL & BOUNDARY MECHANICS",
                "tier_color": (255, 100, 100),
                "name": "Damage Immunity & Boundary Warning",
                "dur": "Passive Mechanics",
                "stats": "Invincible Time: 1.0s upon hit  |  Out-of-Bounds Damage: 0.1 DMG / tick",
                "desc": "Taking damage activates 1.0s immunity. Flying outside 3000x3000px red map incurs tick damage.",
                "color": (255, 120, 120),
            },
        ]
    ...
    def _draw_tab_controls(self, surface, rect):
        ...
        controls = [
            ...
            ("SYSTEMS & NAVIGATION", [
                ...
                ("R KEY", "Instant Respawn with fresh shields upon ship destruction"),
                ("L-SHIFT + R-SHIFT + R", "Reset Highscore to zero (from Main Menu)"),
            ]),
        ]
